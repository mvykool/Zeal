...
const BusinessCard = () => {
  return (
    <div className='pb-8 business-card w-full my-5 rounded-lg shadow-xl relative overflow-hidden px-6'>
    ...
    {/**title and icon*/}
     ...
     {/**hours and users*/}
      ...
      <div className='flex justify-between mt-5'>
        ...
        <div>
          <div className='ml-16 h-8 w-8 flex justify-center text-sm items-center p-5 z-10 absolute rounded-full bg-white'>+42</div>
        </div>
